    ...
    <section class="col-s-12 col-m-12 col-l-4 forfait-accueil">
        <h2 class="title-carte" style="margin-right: 35px;">Découvrez notre carte</h2>
                ...
                <span>
                    ...
                    <img alt="barber" class="contain-img" src="<?php echo DIRNAME . $pic_slideshow['nThird']; ?>" style="width:100%; padding:10px">
                </span>
           
        <a href="<?php echo DIRNAME ."package/getPackage";?>" class="btnForfait col-l-11">Cliquez ici</a>
    </section>
